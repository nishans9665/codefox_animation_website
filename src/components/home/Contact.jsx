...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await axios.post(`${(import.meta.env.VITE_API_URL || (import.meta.env.PROD ? '' : 'http://localhost:5000'))}/api/contacts`, formData);
                    ...
                    <div className="contact-form-wrapper glass-panel reveal" style={{ transitionDelay: '0.2s' }}>
                        <form className="contact-form" onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                ...
                                <input type="tel" id="phone" placeholder="+1 (514) 895-3631" value={formData.phone} onChange={handleChange} />
                            </div>
