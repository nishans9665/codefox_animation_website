                        ...
                        {filteredProjects.length === 0 ? (
                            ...
                            >
                                <div className="portfolio-image-wrap">
                                    <img src={project.image && project.image.startsWith('http') ? project.image : (project.image ? `${(import.meta.env.VITE_API_URL || (import.meta.env.PROD ? '' : 'http://localhost:5000'))}${project.image}` : '')} alt={project.title} className="portfolio-image" />
